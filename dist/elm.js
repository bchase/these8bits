...
var _user$project$Types$PageNotFound = {ctor: 'PageNotFound'};
var _user$project$Types$Portfolio = {ctor: 'Portfolio'};
var _user$project$Types$Homepage = {ctor: 'Homepage'};

var _user$project$Routes$routing = function () {
	var routes = function (page) {
		var _p0 = page;
		switch (_p0.ctor) {
			case 'Homepage':
				return {ctor: '_Tuple2', _0: '/', _1: _p0};
			case 'Portfolio':
				return {ctor: '_Tuple2', _0: '/portfolio', _1: _p0};
			default:
				return {ctor: '_Tuple2', _0: '/404', _1: _p0};
		}
	};
	var routesList = function () {
		var routeTotalityCheck = function () {
			var _p1 = _user$project$Types$PageNotFound;
			switch (_p1.ctor) {
				case 'Homepage':
					return {ctor: '_Tuple0'};
				case 'Portfolio':
		...
		return {
			ctor: '::',
			_0: routes(_user$project$Types$Homepage),
			_1: {
				ctor: '::',
				_0: routes(_user$project$Types$Portfolio),
				_1: {
					ctor: '::',
					_0: routes(_user$project$Types$PageNotFound),
					_1: {ctor: '[]'}
				}
			}
		};
	}();
	var toPage = function (path) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
	...
	var toPath = function (_p3) {
		return _elm_lang$core$Tuple$first(
			routes(_p3));
	};
	return {toPath: toPath, toPage: toPage};
}();
var _user$project$Routes$navigateTo = function (_p4) {
	return _elm_lang$navigation$Navigation$newUrl(
		_user$project$Routes$routing.toPath(_p4));
};
var _user$project$Routes$navigateBy = function (_p5) {
	var _p6 = _p5;
	var _p9 = _p6.pathname;
	var _p7 = {ctor: '_Tuple2', _0: _p6.hostname, _1: _p9};
	if (((_p7.ctor === '_Tuple2') && (_p7._0 === 'localhost')) && (_p7._1 === '/index.html')) {
		return _user$project$Routes$navigateTo(_user$project$Types$Homepage);
	} else {
		return function (_p8) {
			return _user$project$Routes$navigateTo(
				_user$project$Routes$routing.toPage(_p8));
		}(_p9);
	}
};
var _user$project$Routes$navLocationToPage = function (_p10) {
	return _user$project$Routes$routing.toPage(
		function (_) {
			return _.pathname;
		}(_p10));
};

var _user$project$Home$stylesheet = function (url) {
	return A3(
...
var _user$project$Home$homepage = function (_p0) {
	var _p1 = _p0;
	var _p6 = _p1.rows;
		...
		var cols = A2(
			...
			function (_p2) {
				return A2(
					...
					A2(_user$project$Helpers_ops['?'], '1', '0'),
					A2(
						_elm_lang$core$Array$initialize,
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Home$stylesheet('https://fonts.googleapis.com/css?family=Ubuntu+Mono:400,700'),
			_1: {
				ctor: '::',
				_0: A2(
					_rtfeldman$elm_css$Html_Styled$div,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$id('masthead'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Home$portfolio = _rtfeldman$elm_css$Html_Styled$text('portfolio');
var _user$project$Home$pageNotFound = _rtfeldman$elm_css$Html_Styled$text('page not found');
var _user$project$Home$view = function (_p7) {
	var _p8 = _p7;
	var _p9 = _p8.page;
	switch (_p9.ctor) {
		case 'Homepage':
			return _user$project$Home$homepage(_p8);
		case 'Portfolio':
			return _user$project$Home$portfolio;
		default:
...
var _user$project$Home$update = F2(
	function (msg, _p10) {
		var _p11 = _p10;
		var _p13 = _p11;
		var roll = function (rs) {
			return A2(
				_elm_lang$core$List$map,
				function (n) {
					return A2(_user$project$Helpers_ops['?'], 0, n)(
						_elm_lang$core$Native_Utils.cmp(
							n,
							_elm_lang$core$List$length(rs)) > 0);
				},
				A2(
					_elm_lang$core$List$map,
					F2(
		...
		switch (_p12.ctor) {
			...
			case 'ChangePage':
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Routes$navigateTo(_p12._0),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						_p13,
						{
							page: _user$project$Routes$navLocationToPage(_p12._0)
						}),
					{ctor: '[]'});
		}
	});
var _user$project$Home$subscriptions = function (_p14) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
...
var _user$project$Main$main = A2(
	...
	_user$project$Types$SetLocation,
	{
		update: _user$project$Home$update,
		view: function (_p0) {
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				_user$project$Home$view(_p0));
		},
...
if (typeof _user$project$Routes$main !== 'undefined') {
    _user$project$Routes$main(Elm['Routes'], 'Routes', undefined);
}
Elm['Types'] = Elm['Types'] || {};
